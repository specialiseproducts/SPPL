...
export function toDailyPlannerTaskDto(row) {
  ...
  return {
    ...
    reopenedFromStatus: String(row.reopenedFromStatus || '').trim(),
    reopenedBy: String(row.reopenedBy || '').trim(),
    reopenedByName: String(row.reopenedByName || '').trim(),
    reopenedAt: row.reopenedAt || null,
    reopenReason: String(row.reopenReason || '').trim(),
    ...
    clientBatchId: row.clientBatchId ? String(row.clientBatchId).trim() : null,
...
export async function createTask(payload) {
  ...
  const item = {
    ...
    clientBatchId: payload.clientBatchId ? String(payload.clientBatchId).trim() : null,
